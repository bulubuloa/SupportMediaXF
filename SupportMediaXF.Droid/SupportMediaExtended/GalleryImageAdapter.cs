...
{
    public class GalleryImageAdapter : ArrayAdapter<SupportGalleryXF>
    {
        ...
        public GalleryImageAdapter(Context context, List<SupportGalleryXF> galleries, int position, IGalleryPickerSelected galleryPickerSelected) : base(context, Resource.Layout.adapter_photosfolder)
        {
